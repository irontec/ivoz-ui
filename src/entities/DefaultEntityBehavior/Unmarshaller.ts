import { PartialPropertyList, ScalarProperty } from '../../services/api/ParsedApiSpecInterface';
import _ from '../../services/translations/translate';
import { MarshallerValues } from './Marshaller';

// API Response format => formik compatible format
const unmarshaller = (row: MarshallerValues, properties: PartialPropertyList): MarshallerValues => {
